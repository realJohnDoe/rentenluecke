...
/**
 * Two segmented controls for the view options. Both live in `App.tsx` as
 * `useState`, never in the plan — see the "What is a Plan" convention.
 */
export function Toolbar({ scenario, onScenarioChange, valueMode, onValueModeChange }: Props) {
  return (
